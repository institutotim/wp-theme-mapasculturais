    ...
    <div class="container">
      <div class="twelve columns">
        <div class="timeline">
          ...
          <div class="timeline-item row">
            <div class="post-box"><img src="http://lorempixel.com/600/400/?0">
              <h3>Item #2</h3>
          ...
          <div class="timeline-item row">
            <div class="post-box">
              <h3>Item #4</h3>
              <p><img class="u-pull-right" src="http://lorempixel.com/100/100/">Nunc pulvinar nisi sed pretium lobortis. Phasellus id aliquam turpis, ut placerat dolor. Sed consectetur, nisi vel tristique luctus, sem mauris posuere erat, vitae tristique
                enim urna eget turpis.</p>
            </div>
          </div>
          <div class="timeline-item row">
            <div class="post-box"><img src="http://lorempixel.com/600/400/?1">
              <h3>Item #5</h3>
              <p>Nunc pulvinar nisi sed pretium lobortis. Phasellus id aliquam turpis, ut placerat dolor. Sed consectetur, nisi vel tristique luctus.</p>
            </div>
          </div>
